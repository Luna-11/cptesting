...
export async function GET(request: NextRequest) {
  try {
    ...
    // Get overview statistics (removed time-based user metrics)
    ...
    // Get recent users (without created_at sorting)
    ...
    // Get system health metrics (using only activity dates)
    ...
    // Get top performing users (using activity data only)
