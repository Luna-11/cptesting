...
//     switch (reportType) {
//       case 'users':
//         const [usersReport] = await db.query<UserReport[]>(`
//           SELECT 
//             u.user_id,
//             u.name,
//             u.email,
...
//       case 'activity':
//         const [activityReport] = await db.query<ActivityReport[]>(`
//           SELECT 
...
//       case 'engagement':
//         const [engagementReport] = await db.query<EngagementReport[]>(`
//           SELECT 
//             u.user_id,
//             u.name,
//             u.email,
...
//       case 'subscription':
//         const [subscriptionReport] = await db.query<SubscriptionReport[]>(`
//           SELECT 
//             u.user_id,
//             u.name,
//             u.email,
...
//       default: // summary
//         const [summaryStats] = await db.query<SummaryStats[]>(`
//           SELECT 
...
//         const [growthTrends] = await db.query<GrowthTrend[]>(`
//           SELECT 
...
//         const summaryData = summaryStats[0];
...
//     const [customReport] = await db.query<CustomReport[]>(query, queryParams);
